    ...
    return Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 20),
            Text(
              'The Super Mean Biker Gang built the Bike Kollective app as a Free app. This SERVICE is provided by The Super Mean Biker Gang at no cost and is intended for use as is.This page is used to inform visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service. If you choose to use our Service, then you agree to the collection and use of information in relation to this policy. The Personal Information that we collect is used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy. The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Bike Kollective unless otherwise defined in this Privacy Policy.',
            ...
            SizedBox(height: 10),
            Text('To facilitate our Service;', style: TextStyle(fontSize: 15)),
            SizedBox(height: 10),
            ...
            SizedBox(height: 10),
            Text(
              'We may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. We will notify you of any changes by posting the new Privacy Policy on this page. This policy is effective as of 2021-05-22',
              style: TextStyle(fontSize: 15),
            ),
            SizedBox(height: 10),
            Text(
