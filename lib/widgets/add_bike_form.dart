...
class _AddBikeFormState extends State<AddBikeForm> {
  ...
  void getImage() async {
    ...
    Reference ref = storage.ref().child("image " + DateTime.now().toString());  // need better name
            ...
            child: Column(  
              ...
              children: [
                ...
                TextField(  
                  ...
                  decoration: InputDecoration(hintText: "Lock Combination",),
                  ...
                  child: ElevatedButton(   
                    ...
                    onPressed: () {
                      ...
                      FirebaseFirestore.instance.collection('bikes').add({
                        'bikeName' : 'Bike Name', // Will add appropriate form spot later
                        'latitude': locationData != null ? locationData.latitude : 45,
                        'longitude': locationData != null ? locationData.longitude : 30,
                        'tags' : ['Tag1', 'Tag2'],  // Will add appropriate spot in form later
                        'rating' : null,    // Not sure how we want bike ratings to start before being used
                        'photoUrl': imageURL,
                        'isBeingUsed': false,
                        'lockCombo': lockComboController.text != "" ? lockComboController.text : "0",
                        'donatedUserEmail' : "userEmail@email.com", // Will add logic to determined logged in user's email
                      });
